...
Доступные операции:
  ...
  --uncfg             Выполнить параллельный поиск новых ONU по всей сети OLT.
  --uncfg-old         Показать давно висящие (>24 часов) незарегистрированные ONU.
...
def parse_arguments():
    ...
    group.add_argument("--uncfg", action="store_true", help="Поиск новых незарегистрированных ONU")
